...
<body>
    <div class="container">
        ...
        <section id="introduction">
            <h2>Introduction</h2>
            <p>
                "Ethiopia Unbound" is a seminal work of African literature by Joseph Casely Hayford. Published in 1911, it is one of the earliest novels written in English by an African author. The novel explores themes of identity, nationalism, and the African diaspora.
            </p>
        </section>
